...
<div className="flex items-center gap-4">
  {session && (
    <>
      <Link
        href="/admin"
        className="hidden sm:inline-block text-gray-900 dark:text-gray-100 hover:text-toyota-red px-3 py-2 text-sm font-medium transition-colors"
      >
        Dashboard
      </Link>
      <Link
        href="/admin"
        className="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-toyota-red hover:bg-toyota-darkred"
      >
        Panel Admin
      </Link>
    </>
